      <div class="sidebar">
        <ul class="list-unstyled components">
          ...
          <li>
            <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle parent">
              <span class="icon">
            ...
            <ul class="collapse list-unstyled submenu" id="homeSubmenu">
                <li>
                    <a href="<?= BASEURL; ?>dashboard/home1">Home 1</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>dashboard/home2">Home 2</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>dashboard/home3">Home 3</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>dashboard/home4">Home 4</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>dashboard/home5">Home 5</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>dashboard/home6">Home 6</a>
                </li>
          ...
          <li>
            <a href="<?= BASEURL; ?>dashboard/about" class="parent">
              <span class="icon">
          ...
          <li>
            <a href="<?= BASEURL; ?>dashboard/protofolio" class="parent">
              <span class="icon"><i class="fa fa-globe"></i></span>
              <span class="title">Portofolio</span>
            </a>
          </li>
          <li>
            <a href="<?= BASEURL; ?>dashboard/contact" class="parent">
              <span class="icon"><i class="fa fa-globe"></i></span>
